...
class CrossrefTest {
    ...
    void setup() {
        ...
        bibentry.setField(StandardField.AUTHOR, "Max Mustermann");
        bibentry.setField(StandardField.BOOKAUTHOR, "Max Mustermann");
        bibentry.setField(StandardField.YEAR, "2030");
        bibentry.setField(StandardField.DOI, "doi");
        bibentry.setField(StandardField.ISSN, "1312");
        bibentry.setField(StandardField.PAGES, "100");
        bibentry.setField(StandardField.BOOKTITLE, "Max Mustermann memoirs");
    }
    ...
    //  void jsontoentrytest(jsonobject item, bibentry expected) {
    //     bibentry result = crossref.performsearch();
    // }
//
    // private static stream<arguments> jsonsource() {
    //     return stream.of(
    ...
    @Test
    public void extractIdentifierTest() throws Exception {
        BibEntry entry1 = new BibEntry();
        entry1.setField(StandardField.TITLE, "Towards Application Portability in Platform as a Service");
        entry1.setField(StandardField.AUTHOR, "Stefan Kolb");
        entry1.setField(StandardField.DOI,"123");
        BibEntry entry2 = new BibEntry();
        entry2.setField(StandardField.TITLE, "Test123");
        entry2.setField(StandardField.AUTHOR, "Mister olb");
        entry2.setField(StandardField.DOI,"321");


        List<BibEntry> fetchedEntries = new ArrayList<>();
        fetchedEntries.add(entry1);
        fetchedEntries.add(entry2);
        crossRef.extractIdentifier(entry1,fetchedEntries);
        assertEquals("123",crossRef.extractIdentifier(entry1,fetchedEntries));
    }
